...
def defence(char_name: str, char_class: str) -> str:
    """Функция defence показывает количество заблокированного урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция special определяет специальный навык персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Тренировочная функция для знакомства с механикой игры."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция выбора типа персонажа пользователем."""
    approve_choice: str = ''
    char_class: str = ''
